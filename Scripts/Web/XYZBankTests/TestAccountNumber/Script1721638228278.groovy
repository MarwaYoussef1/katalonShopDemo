...
WebUI.click(findTestObject('Object Repository/Page_XYZ Bank/strong_1001'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_XYZ Bank/strong_1001'), '1001')
