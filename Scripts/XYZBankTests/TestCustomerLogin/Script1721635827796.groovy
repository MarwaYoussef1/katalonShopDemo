...
WebUI.click(findTestObject('Object Repository/Page_XYZ Bank/span_Hermoine Granger'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_XYZ Bank/span_Hermoine Granger'), 'Hermoine Granger')
...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_XYZ Bank/select_---Your Name---       Hermoine Grang_6e895b'))
