...
WebUI.setText(findTestObject('Object Repository/Page_XYZ Bank/input_First Name_form-control ng-pristine n_693e51'), 'Harry')

WebUI.verifyElementText(findTestObject('Object Repository/Page_XYZ Bank/td_Harry'), 'Harry')
