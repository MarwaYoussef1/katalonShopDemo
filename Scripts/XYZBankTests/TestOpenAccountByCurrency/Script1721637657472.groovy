...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_XYZ Bank/select_1007100810091016'), 'number:1016', true)

WebUI.click(findTestObject('Object Repository/Page_XYZ Bank/strong_Pound'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_XYZ Bank/strong_Pound'), 'Pound')
